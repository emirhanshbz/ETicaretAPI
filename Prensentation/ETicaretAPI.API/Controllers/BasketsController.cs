...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class BasketsController : ControllerBase
    {
        ...
        [HttpGet]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Baskets, ActionType = ActionType.Reading, 
        ...
        [HttpPost]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Baskets, ActionType = ActionType.Writing,
        ...
        [HttpPut]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Baskets, ActionType = ActionType.Updating,
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Baskets, ActionType = ActionType.Deleting,
