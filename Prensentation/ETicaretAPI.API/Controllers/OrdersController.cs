...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        [HttpGet("{Id}")]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Orders, ActionType = ActionType.Reading,
        ...
        [HttpPost]
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Orders, ActionType = ActionType.Writing,
        ...
        [AuthorizeDefinition(Menu = AuthorizeDefinitionContants.Orders, ActionType = ActionType.Updating,
